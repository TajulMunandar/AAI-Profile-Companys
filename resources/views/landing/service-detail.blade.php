...
@section('title', $service->title . ' - Atlantic Alam Industri')
            ...
            <div class="col-lg-4">
                ...
                <div class="card border mb-4">
                    <div class="card-header bg-light">
                        <h5 class="mb-0 fw-semibold">Other Services</h5>
                    </div>
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush">
                            @foreach(\App\Models\Service::where('id', '!=', $service->id)->get() as $otherService)
                            <li class="list-group-item">
                                <a href="{{ url('/service/' . $otherService->slug) }}" class="text-decoration-none d-flex align-items-center">
                                    @if($otherService->icon)
                                    <i class="{{ $otherService->icon }} me-2"></i>
                                    @endif
                                    {{ $otherService->title }}
                                </a>
                            </li>
