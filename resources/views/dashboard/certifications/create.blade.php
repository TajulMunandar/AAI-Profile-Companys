        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="ti ti-pencil-plus me-2"></i>Create New Certification
                </h5>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="title" name="title"
                                       value="{{ old('title') }}" placeholder="Enter certification title..." required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="4"
                                          placeholder="Enter certification description (optional)...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <button type="submit" class="btn btn-primary w-100 btn-lg">
                                <i class="ti ti-plus me-1"></i>Create Certification
                            </button>
                        </div>
                    </div>
                </form>
