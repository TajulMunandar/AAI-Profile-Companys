        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="ti ti-pencil-plus me-2"></i>Create New Article
                </h5>
            ...
            <div class="card-body p-4">
                <form action="{{ route('dashboard.articles.store') }}" method="POST" enctype="multipart/form-data" id="articleForm">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tag" name="tag"
                                               value="{{ old('tag') }}" placeholder="news, update, info">
                            ...
                            <button type="submit" class="btn btn-primary w-100 btn-lg">
                                <i class="ti ti-plus me-1"></i>Create Article
                            </button>
                        </div>
                    </div>
                </form>
