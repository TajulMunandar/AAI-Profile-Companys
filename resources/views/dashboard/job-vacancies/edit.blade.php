        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="ti ti-pencil me-2"></i>Edit Job Vacancy
                </h5>
            ...
            <div class="card-body p-4">
                <form action="{{ route('dashboard.job-vacancies.update', $jobVacancy->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="title" name="title"
                                       value="{{ old('title', $jobVacancy->title) }}" placeholder="Enter job title..." required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="requirements" name="requirements" rows="5"
                                          placeholder="Enter job requirements...">{{ old('requirements', $jobVacancy->requirements) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="is_active" name="is_active">
                                            <option value="1" {{ old('is_active', $jobVacancy->is_active) == 1 ? 'selected' : '' }}>Open</option>
                                            <option value="0" {{ old('is_active', $jobVacancy->is_active) == 0 ? 'selected' : '' }}>Closed</option>
                                        </select>
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary w-100 btn-lg">
                                <i class="ti ti-pencil me-1"></i>Update Job Vacancy
                            </button>
                        </div>
                    </div>
                </form>
