<footer class="footer-section">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 sm-padding">
                    <div class="footer-content">
                        <img class="logo" src="{{ asset('assets/logo website aai.png') }}" alt="logo" width="180">
                ...
                <div class="col-lg-4 col-md-6 sm-padding">
                    <div class="footer-content">
                        ...
                        <ul class="footer-list">
                            <li><strong>Head Office:</strong><br>Engineering, Procurement & Construction</li>
                            <li><strong>Branch Office:</strong><br>Jln. Kenari No: 129A BTN Lama Panggoi<br>Kec. Muara Dua Kota Lhokseumawe 24352 - Aceh<br><a href="tel:+6264541042">+62 645 41042</a></li>
                            <li><strong>WorkShop:</strong><br>Jln. Medan - B.Aceh Paloh. No: 102<br>Kec. Muara satu, Kota Lhokseumawe<br><a href="tel:+626456502123">+62 645 6502123</a></li>
                            <li><strong>Jakarta Office:</strong><br>Jln. Mampang Prapatan XVIII Blok C No.3<br>Duren Tiga, Pancoran, Jakarta Selatan 12760<br><a href="tel:02127533271">(021) 27533271</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 sm-padding">
    ...
    <div class="footer-bottom text-center">
        <div class="container">
            <p>© Copyright 2026 PT. ATLANTIC ALAM INDUSTRI - All Rights Reserved. | Made by <a href="https://developerdadakan.vercel.app/" target="_blank" rel="noopener noreferrer">Developer Dadakan</a></p>
        </div>
    </div>
